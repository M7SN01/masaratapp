...
class SearchList {
  ...
  String name;
  bool state;
  SearchList({required this.id, required this.name, this.state = false});
}
...
Widget optionSwitcher({
  required final Widget searchOptions,
  required final Function(bool) state,
  ...
  return Column(
    children: [
      IconButton(
        ...
        icon: isShowed
            ? const Icon(Icons.keyboard_control_key)
            : const RotatedBox(
                quarterTurns: 90,
