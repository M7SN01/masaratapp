      ...
      builder: (controller) => Scaffold(
        ...
        body: PdfPreview(
          ...
          build: (PdfPageFormat format) async {
            ...
            //cairo
            // final cfontDataR = await rootBundle.load("assets/fonts/Cairo-Regular.ttf");
            // final cfontR = pw.Font.ttf(cfontDataR);
            // final cfontDataB = await rootBundle.load("assets/fonts/Cairo-Bold.ttf");
            // final cfontB = pw.Font.ttf(cfontDataB);

            /**************************************important************************************* */
            // pw.Font font3 = await PdfGoogleFonts.notoNaskhArabicRegular();
            // // font3 = await PdfGoogleFonts.lateefRegular();
            // // font3 = await PdfGoogleFonts.markaziTextRegular();
            // font3 = await PdfGoogleFonts.amiriRegular();
            /******************************************************************************* */
            final pdf = pw.Document(
              //to make font defult for all text in the pdf
              theme: pw.ThemeData.withFont(
                base: await controller.getPdfFontByName(controller.selectedFont),
                bold: await controller.getPdfBoldFontByName(controller.selectedFont),
                italic: font,
                boldItalic: font,
              ),
            );
