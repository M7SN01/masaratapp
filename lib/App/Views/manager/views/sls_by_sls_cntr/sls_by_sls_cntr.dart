  ...
  Widget build(BuildContext context) {
    return GetBuilder<SlsCenterController>(
      builder: (controller) => Scaffold(
        appBar: AppBar(
          title: Text("مبيعات حسب مراكز البيع"),
          centerTitle: true,
        ),
        body: _body(),
      ),
        ...
        children: [
          ...
          Expanded(
            child: controller.showMonthRep
                ? tableView(tableOPtions: controller.fullViewTableOptions(columns: SlsBySlsCntrColumns().getColumnsByMonthRep))
                          ...
                          child: TabBarView(
                            ...
                            children: [
                              tableView(
                                ...
                                columns: SlsBySlsCntrColumns().getColumnsFromToDateRep(
